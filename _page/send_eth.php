...
<form class="send card-body" method="POST" action="#" id="cryptoForm" style="height:100%;">
    ...
    <input type="hidden" id="coinSelect" name="network" value="ethereum">
    <input type="text" name="wallet" class="form-control w-100" placeholder="Wallet Address" required>
    <input type="number" name="amount" class="form-control w-100" placeholder="USD AMOUNT" id="amountInput" step="any" title="Currency" required pattern="^\d+(?:\.\d{1,2})?$">
    <span class="input-group-btn">
        <p id="result" style="color:green"></p>
        <p id="usd" style="color:red"></p>
    </span>
    <button class="btn btn-success" name="send_eth">SEND </button>
</form>
