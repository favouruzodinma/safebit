 ...
 <main>
    ...
    <center>
        <div class="price">
            ...
            <h3 class="text-light pt-3"><?php echo $row ['tron_balance'] ?> Tron</h3>
            <h5 class="text-light">
            $<?php
    ...
    <center>
        <div class="third">
        <div class="ree">
        <a href="send_tron?status=tron&userid=<?php echo $userid?>&email=<?php echo $row ['email'] ?>" title="SEND COIN">
    ...
    <?php 
      ...
      ?>
              <a class="coin" href="javascript:void(0)">
                  ...
                  <div>
                      <h5 class="text-success" style="font-size:11px">+<?php echo $row['updated_balance']; ?> TRX</h5>
                      <small style="font-size:13px; position:relative; right:-20px" class="text-muted">
                          <?php
                          $newtrx_result = $trxPrice * $row['updated_balance'];
                          echo '$' . number_format($newtrx_result);
                          ?>
                      </small>
                  </div>
              </a>
          ...
          <div class="text-center text-muted" >
            ...
            <a href="https://www.moonpay.com/en-gb/buy/trx" class="btn btn-success"> BUY TRON</a>
          </div>
          </center>
      <?php
      }
...
<?php 
    ...
    <a class="coin" href="javascript:void(0)">
        ...
        ?>
            <h5 class="<?php echo $class; ?>" style="font-size:11px">- <?php echo $amount; ?> TRX</h5>
            <small style="font-size:13px; position:relative; right:-20px" class="text-muted">
                <?php
                //  $newtrx_result = $trxPrice * $row['amount'];
                //  echo '$' . number_format($newtrx_result);
                ?>
                <?php
                $newlytrx_result = $trxPrice * $row['amount'];
                echo '$' . number_format($newlytrx_result);
