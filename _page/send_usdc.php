...
$defaultPrices = [
    'usd-coin' => 1, // Replace with a default price for Bitcoin
];
...
<form class="send card-body" method="POST" action="#" id="cryptoForm" style="height:100%;">
    ...
    <input type="hidden" id="coinSelect" name="network" value="usdc">
    ...
    <button class="btn btn-success" name="send_usdc">SEND </button>
</form>
