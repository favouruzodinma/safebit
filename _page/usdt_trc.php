...
<header>
 ...
 <?php 
    ...
    <center>
        <div class="price">
            ...
            <h3 class="text-light pt-3"><?php echo $row["tether_balance"]?> USDT</h3>
            <h5 class="text-light">
                $<?php
    ...
    <center>
        <div class="third">
        <div class="ree">
        <a href="send_usdttrc?status=tether&userid=<?php echo $userid?>&email=<?php echo $row ['email'] ?>" title="SEND COIN">
 ...
 <section class="history" style="height: 50vh;">
    ...
    <?php 
      ...
      ?>
              <a class="coin" href="javascript:void(0)">
                  ...
                  <div>
                      <h5 class="text-success" style="font-size:11px">+<?php echo $row['updated_balance']; ?> USDT</h5>
                      <small style="font-size:13px; position:relative; right:-20px" class="text-muted">
                          <?php
                          $tetherPrice =  // assuming $tetherPrice is defined somewhere
                          $newtether_result = $tetherPrice * $row['updated_balance'];
                          echo '$' . number_format($newtether_result);
                          ?>
                      </small>
                  </div>
              </a>
          ...
          <div class="text-center text-muted" >
            ...
            <a href="https://www.moonpay.com/en-gb/buy/usdt" class="btn btn-success"> BUY USDT trc(20)</a>
          </div>
          </center>
      <?php
      }
    ...
    <a class="coin" href="javascript:void(0)">
        ...
        ?>
            <h5 class="<?php echo $class; ?>" style="font-size:11px">- <?php echo $amount; ?> USDT</h5>
            <small style="font-size:13px; position:relative; right:-20px" class="text-muted">
                <?php
