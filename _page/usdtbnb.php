 ...
 <?php 
    ...
    <center>
        <div class="price">
            ...
            <h3 class="text-light pt-3"><?php echo $row ['usd-tether_balance'] ?> USDT</h3>
            <h5 class="text-light">
            $<?php
    ...
    <center>
        <div class="third">
        <div class="ree">
        <a href="send_usdtbnb?status=usd-coin&userid=<?php echo $userid?>&email=<?php echo $row ['email'] ?>" title="SEND COIN">
 ...
 <section class="history" style="height: 50vh;">
    ...
    <a class="coin" href="javascript:void(0)">
        ...
        ?>
            ...
            <small style="font-size:13px; position:relative; right:-20px" class="text-muted">
                <?php
                $newusdtbnb_result = $usdtbnbPrice * $row['amount'];
                echo '$' . number_format($newusdtbnb_result);
                ?>
            </small>
        </div>
