...
<header style="height: 10vh;">
 ...
 <main>
    ...
    <center>
        <div class="price">
            ...
            <h3 class="text-light pt-3"><?php echo $row ['ethereum_balance'] ?> ETH</h3>
            <h5 class="text-light">
            $<?php
    ...
    <center>
        <div class="third">
        <div class="ree">
        <a href="send_eth?status=ethereum&userid=<?php echo $userid?>&email=<?php echo $row ['email'] ?>" title="SEND COIN">
 ...
 <section class="history" style="height: 50vh;">
   ...
   <?php 
      ...
      $coinType = 'ethereum'; // Set coinType as 'ethereum'
      ...
      ?>
              <a class="coin" href="javascript:void(0)">
                  ...
                  <div>
                      <h5 class="text-success" style="font-size:13px">+<?php echo $row['updated_balance']; ?> ETH</h5>
          ...
          <div class="text-center text-muted" >
            ...
            <a href="https://www.moonpay.com/en-gb/buy/eth" class="btn btn-success"> BUY ETH</a>
          </div>
          </center>
      <?php
      }
    ...
    <a class="coin" href="javascript:void(0)">
        ...
        ?>
            <h5 class="<?php echo $class; ?>" style="font-size:11px">- <?php echo $amount; ?> ETH</h5>
            <small style="font-size:11px; position:relative; right:-20px" class="text-muted">
                <?php
                $newethereum_result = $ethereumPrice * $row['amount'];
                echo '$' . number_format($newethereum_result);
                ?>
            </small>
        </div>
