 ...
 <?php 
    ...
    <center>
        <div class="price">
            ...
            <h3 class="text-light pt-3"><?php echo $row ['usd-coin_balance'] ?> USDT</h3>
            <h5 class="text-light">
                $<?php
    ...
    <?php 
      ...
      ?>
              <a class="coin" href="javascript:void(0)">
                  ...
                  <div>
                      ...
                      <small style="font-size:13px; position:relative; right:-20px" class="text-muted">
                          <?php
                          $newusdcoin_result = $usdCoinPrice * $row['updated_balance'];
          ...
          <div class="text-center text-muted" >
            ...
            <a href="https://www.moonpay.com/en-gb/" class="btn btn-success"> BUY USDT erc(20)</a>
          </div>
          </center>
      <?php
      }
